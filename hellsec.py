...
def keyword_list():
    global keyword_top
    keyword_top.extend([
        'Ecosistema', 'Sell', 'Vageta', 'Robin Williams', 'World Cup',
        'Ca Si Le Roi', 'Ebola', 'Malaysia Airlines Flight 370',
        'ALS Ice Bucket Challenge', 'Flappy Bird', 'Conchita Wurst', 'Icecream', 'U.S. Military',
        'Frozen', '014 Sochi Winter Olympics', 'IPhone', 'Samsung Galaxy S5',
        'Nexus 6', 'Moto G', 'Samsung Note 4', 'LG G3', 'Xbox One',
        'Apple Watch', 'Nokia X', 'Ipad Air', 'Facebook', 'DJ Bach',
        'Ecosistema', 'Sunday', 'Sam', 'Icecream', 'World Cup',
        'Ca Si Le Roi', 'Ebola', 'Malaysia Airlines Flight 370',
        'ALS Ice Bucket Challenge', 'Flappy Bird', 'Conchita Wurst', 'U.S. Military',
        'Frozen', '014 Sochi Winter Olympics', 'IPhone', 'Samsung Galaxy S5',
        'Nexus 6', 'Moto G', 'Samsung Note 4', 'LG G3', 'Xbox One',
        'Apple Watch', 'Nokia X', 'Ipad Air', 'Facebook', 'DJ Bach',
        'Fortnite', 'Default', 'Roblox', 'Robin Williams', 'World Cup',
        'Ca Si Le Roi', 'Ebola', 'Malaysia Airlines Flight 370',
        'ALS Ice Bucket Challenge', 'Flappy Bird', 'Conchita Wurst', 'U.S. Military',
        'Hamas', 'Frozen', '014 Sochi Winter Olympics', 'IPhone',
        'Samsung Galaxy S5', 'Nexus 6', 'Moto G', 'Samsung Note 4',
        'LG G3', 'Xbox One', 'Apple Watch', 'Nokia X', 'Ipad Air',
        'Facebook', 'Icecream', 'DJ Bach', 'Ecosistema', 'Sul',
        'Sell', 'Robin Williams', 'World Cup', 'Ca Si Le Roi', 'Ebola',
        'Malaysia Airlines Flight 370', 'ALS Ice Bucket Challenge', 'Flappy Bird',
        'Conchita Wurst', 'U.S. Military', 'Frozen', '014 Sochi Winter Olympics',
        'IPhone', 'Samsung Galaxy S5', 'Nexus 6', 'Moto G', 'Samsung Note 4',
        'LG G3', 'Xbox One', 'Apple Watch', 'Nokia X', 'Ipad Air', 'Facebook',
        'Icecream', 'DJ Bach', 'Ecosistema', 'Sullow', 'Sell', 'Robin Williams',
        'World Cup', 'Ca Si Le Roi', 'Ebola', 'Malaysia Airlines Flight 370',
        'ALS Ice Bucket Challenge', 'Flappy Bird', 'Conchita Wurst', 'U.S. Military',
        'Frozen', '014 Sochi Winter Olympics', 'IPhone', 'Samsung Galaxy S5',
        'Nexus 6', 'Moto G', 'Samsung Note 4', 'LG G3', 'Xbox One',
        'Apple Watch', 'Nokia X', 'Ipad Air', 'Facebook', 'Icecream',
        'DJ Bach', 'Ecosistema', 'Suaide', 'lavot', 'Robin Williams', 'World Cup',
        'Ca Si Le Roi', 'Ebola', 'Malaysia Airlines Flight 370', 'ALS Ice Bucket Challenge',
        'Flappy Bird', 'Conchita Wurst', 'U.S. Military', 'Frozen', '014 Sochi Winter Olympics',
        'IPhone', 'Samsung Galaxy S5', 'Nexus 6', 'Moto G', 'Samsung Note 4', 'LG G3',
        'Xbox One', 'Apple Watch', 'Nokia X', 'Ipad Air', 'Facebook', 'Icecream', 'DJ Bach',
        'adidas', 'ask.fm', 'adele', 'HaxStroke', 'Dambrok', 'Handman', 'Robin Williams',
        'World Cup', 'Ca Si Le Roi', 'Ebola', 'Malaysia Airlines Flight 370',
        'ALS Ice Bucket Challenge', 'Flappy Bird', 'Conchita Wurst', 'U.S. Military',
        'Frozen', '014 Sochi Winter Olympics', 'IPhone', 'Samsung Galaxy S5',
        'Nexus 6', 'Moto G', 'Samsung Note 4', 'LG G3', 'Xbox One',
        'Apple Watch', 'Nokia X', 'Ipad Air', 'Facebook', 'Icecream', 'DJ Bach'
    ])
...
#http request
 # Make sure to import the urllib2 module
def httpcall(url):
    useragent_list()
    referer_list()
    code = 0
